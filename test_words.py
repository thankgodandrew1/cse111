...
# assert make_full_name("Jonathan", "Samosa") == "Samosa; Jonathan"
#     assert make_full_name("Thank-God", "Anderson") == "Anderson; Thank-God"
#     assert make_full_name("Daniel", "Johannesburg") == "Johannesburg; Daniel"
   

#    assert extract_family_name("Jonathan", "Samosa") == "Samosa"
#     assert extract_family_name("Thank-God", "Anderson") == "Anderson"
#     assert extract_family_name("Daniel", "Johannesburg") == "Johannesburg"
    

#     assert extract_given_name("Jonathan", "Samosa") == "Jonathan"
#     assert extract_given_name("Thank-God", "Anderson") == "Thank-God"
#     assert extract_given_name("Daniel", "Johannesburg") == "Daniel"
