...
def print_death_age(people_dict):
    ...
    Return: nothing
    """
    #run through the peoples dictionary using a for loop
    for key, value in people_dict.items():
        ...
        age = death - birth 
        #prints the name, gender , birth_year, and death_year
        print(f'{name} {age}')     
    pass
...
def count_genders(people_dict):
    ...
    length = len(people_dict)
    f_total = length - m_total

    print('Genders')
    print('The number of males are:', m_total)
    print('The number of females are:', f_total)
    pass
